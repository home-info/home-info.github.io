...
while current_date <= date(year, 12, 31):
    ...
    if not os.path.exists('wochen/woche-' + str(kalenderwoche) + '.html'):
        with open('wochen/woche-' + str(kalenderwoche) + '.html', 'w') as week_file:
            week_file.write("<!DOCTYPE HTML><html><head><title>Essensplan</title>    <meta charset='utf-8'/>    <meta name='viewport' content='width=device-width, initial-scale=1, user-scalable=no'/>    <link rel='stylesheet' href='../assets/css/main.css'/>    <noscript>        <link rel='stylesheet' href='../assets/css/noscript.css'/>    </noscript></head><body class='is-preload'><div id='wrapper' class='fade-in'>    <div id='intro'><h1>Essensplan</h1>        <ul class='actions'>            <li><a href='#header' class='button icon solid solo fa-arrow-down scrolly'>Continue</a></li>        </ul>    </div>    <header id='header'><a href='../index.html' class='logo'>Essensplan</a></header>    <nav id='nav'>        <ul class='links'>            <li><a href='../index.html'>Übersicht</a></li> <li class='active'><a>Wochenansicht</a></li>      </ul>    </nav>    <div id='main'>        <section class='post'>            <header class='major'>   <h1>"+str(kalenderwoche_int)+". Woche</h1> <button><a class='logo' href='woche-"+str(kalenderwoche_int-1).zfill(2)+".html'>⬅️ Vorige</a></button> <button id='speiseplan-link2'>Test</button> <button><a href='woche-"+str(kalenderwoche_int+1).zfill(2)+".html'>Nächste ➡️</a></button></header>")
